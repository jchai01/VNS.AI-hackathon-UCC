...
def handle_chat():
    try:
        ...
        - date_from: "1970-01-01" (matches all logs from the beginning)
        - date_to: "2099-12-31" (matches all logs up to the future)
        ...
        try:
            ...
            if json_response['type'] == 'filter' and isinstance(json_response['data'], dict):
                ...
                if not data.get('date_from'):
                    data['date_from'] = '1970-01-01'
                if not data.get('date_to'):
                    data['date_to'] = '2099-12-31'
...
def handle_voice_chat():
    try:
        ...
        2. Use default values for any unspecified fields:
           ...
           - Use "1970-01-01" to "2099-12-31" for unspecified date ranges
        ...
        try:
            ...
            if json_response['type'] == 'filter' and isinstance(json_response['data'], dict):
                ...
                data['date_from'] = data.get('date_from') or "1970-01-01"
                data['date_to'] = data.get('date_to') or "2099-12-31"
